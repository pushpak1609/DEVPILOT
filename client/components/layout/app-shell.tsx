  ...
  return (
    <SidebarProvider>
      ...
      <SidebarInset>
        ...
        {/*
          min-h-0 is essential here: flex items default to min-height:auto,
          which means this column refuses to shrink below its content's
          natural height. Without it, a tall chat (long messages, streaming
          replies) forces this whole column — and the Sidebar next to it —
          to grow instead of clipping to the viewport, so the browser page
          itself scrolls instead of the inner ScrollArea in ChatMessages.
          That's what was causing the sidebar to visibly scroll away when
          the chat panel grew tall.
        */}
